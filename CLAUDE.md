...
**Outputs:** 4 OCI desktop images (snow, snowloaded, snowfield, snowfieldloaded), 2 OCI server images (cayo, cayoloaded), and 13 sysext overlay images (1password-cli, bitwarden, code-server, debdev, dev, docker, edge, himmelblau, incus, nix, podman, tailscale, vscode).
