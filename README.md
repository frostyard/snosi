...
| `copilot-review-apply.yml` | Submitted PR review / manual | Validates actionable feedback on an internal PR and asks Copilot to apply it once; missing-token automatic runs warn and no-op |
