...
4. Uploads manifests to R2 for tracking
5. Creates a GitHub Release (main-branch pushes only) with a changelog generated by diffing the new `snowloaded` image against the previously published one — see [Releases](https://github.com/frostyard/snosi/releases)
