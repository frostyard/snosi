...
# profiles put it in the signed UKI .cmdline); the theme + Theme=snow config
# ship in the snow ExtraTrees. ExtraTrees, NOT SkeletonTrees: the final
# initrd is generated by the dracut PostInstallationScript (which runs after
...
snowtree="$root/shared/snow/tree"
[[ -f "$snowtree/usr/share/plymouth/themes/snow/snow.plymouth" ]]
[[ -f "$snowtree/usr/share/plymouth/themes/spinner/watermark.png" ]]
[[ -f "$snowtree/etc/plymouth/plymouthd.conf" ]]
