...
# build-time /var path.
require_line "$composition" 'ExtraTrees=%D/shared/floe/tree' "shared bootc scaffold is missing"
...
require_line "$postinst" 'qt6/plugins/discover/packagekit-backend\.so' "PackageKit Discover backend is not stripped"
